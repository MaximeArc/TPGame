...
public class Game {
    ...
    private boolean processCommand(Command command) {
        ...
        if (commandWord.equals(CommandWord.HELP.toString()))
            printHelp();
        else if (commandWord.equals(CommandWord.GO.toString()))
            goRoom(command);
        else if (commandWord.equals(CommandWord.QUIT.toString()))
            wantToQuit = quit(command);
        else if (commandWord.equals(CommandWord.LOOK.toString()))
            look();
